...
class Players(
    ...
    def select_player(self, detailed=True, clear_player=False, header=None, combined=False):
        ...
        selector = PlayerSelectWithClearDefault if clear_player else PlayerSelect
        return selector(players=self.dialog_players, header=header or get_localized(32042), detailed=detailed).select(combined=combined)
